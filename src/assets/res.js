import holistic from "/src/assets/holistic.png";
import innovative from "/src/assets/innovative.png";
import informed from "/src/assets/informed.png";
import empower from "/src/assets/empower.png";

import valentine from "/src/assets/valentine.jpg";
import precious from "/src/assets/precious.jpg";

export const attributes = [
  {
    title: "Holistic Integration",
    body: "Seamlessly navigate between academic pursuits and leisure activities with SyncNexa's all-inclusive platform, designed to streamline your university life.",
    image: holistic,
  },
  {
    title: "Innovative Networking",
    body: "Forge connections with peers, esteemed faculty members, and industry leaders to foster collaboration and mentorship opportunities.",
    image: innovative,
  },
  {
    title: "Stay Informed, Stay Ahead",
    body: "Stay abreast of relevant news, trends, and developments impacting your field of study, ensuring you remain ahead in your academic and professional pursuits.",
    image: informed,
  },
  {
    title: "Empower Your Future",
    body: "Access a dynamic marketplace offering internship placements, job openings, and career resources, empowering you to shape your future career path.",
    image: empower,
  },
];
...
export const teamShort = [
  {
    fullName: "Amauche Anthony (a.k.a King Tony)",
    role: "Founder & CEO, SyncNexa",
    socials: {
      linkedin: "",
      x: "",
      instagram: "",
  ...
  },
  {
    ...
    role: "Social Media Manager, SyncNexa",
    socials: {
      linkedin: "",
      x: "",
      instagram: "",
  ...
  {
    fullName: "Ezeonyeasi Valentine Chianugo",
    role: "Frontend Developer, SyncNexa",
    socials: {
      linkedin: "",
      x: "",
      instagram: "",
  ...
  {
    fullName: "Iwu Precious Ifeoma",
    role: "Copywriter and Content Specialist, SyncNexa",
    socials: {
      ...
      x: "https://x.com/precious_i51345?t=wMKK7WCYu2F16Q5FQeYLsA&s=09",
      instagram:
        "https://www.instagram.com/preshy_iwu?igsh=MWE4aTc2dWo3M3htNA==",
    },
    short:
...
export const teamLong = [
  ...
  },
  {
    ...
    long: `Ezeonyeasi Valentine Chianugo is a talented Frontend Developer at SyncNexa, bringing his expertise in creating visually appealing and user-friendly interfaces to the platform. With a strong background in web development and a passion for design, Valentine plays a crucial role in enhancing the user experience on SyncNexa.
...
Valentine is known for his meticulous attention to detail, creative problem-solving abilities, and commitment to staying current with industry trends. His contributions to SyncNexa are integral to the platform's mission of linking minds and building futures, making him a valuable member of the development team.`,
  ...
  },
  {
    ...
    long: `Iwu Precious Ifeoma is the dedicated Copywriter and Content Specialist at SyncNexa. An Information Technology student at the Federal University of Technology Owerri, Precious combines her academic background with a passion for tech and communication to craft compelling narratives for SyncNexa's diverse audience.
...
Precious is known for her positive attitude and infectious enthusiasm. She believes in the power of a smile to brighten up any situation and is dedicated to fostering a vibrant and supportive community at SyncNexa.`,
    image: precious,
  },
];
